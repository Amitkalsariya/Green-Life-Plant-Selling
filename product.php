...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .top-breadcrumb-area { background-size: cover; background-position: center; width: 100%; padding: 50px 0; text-align: center; }
        .breadcrumb { background: none; padding: 10px 15px; }
        .product-section { padding: 50px 0; }
        .product-container { display: flex; flex-wrap: wrap; justify-content: center; gap: 20px; padding: 0 10px; }
        .product-card { background: #ffffff; width: 280px; border-radius: 10px; overflow: hidden; box-shadow: 0px 4px 15px rgba(0, 0, 0, 0.1); transition: transform 0.3s ease-in-out; text-align: center; padding-bottom: 15px; }
        .product-card:hover { transform: translateY(-5px); }
        .product-card img { max-width: 100%; height: 200px; object-fit: cover; border-radius: 10px 10px 0 0; }
        .product-title { font-size: 18px; font-weight: bold; margin: 15px 0 5px; color: #333; }
        .product-price { font-size: 16px; font-weight: bold; color: #28a745; margin-bottom: 10px; }
        .add-to-cart-btn { background-color: #28a745; color: white; padding: 8px 15px; border-radius: 5px; text-decoration: none; font-size: 14px; transition: background 0.3s ease-in-out; display: inline-block; }
