...
$payment_id = $_GET['payment_id']; // Get Payment ID from URL
                ...
                <div class="col-12">
                    <div class="checkout-scard card border-0 rounded">
                        <div class="card-body text-center">
                            <p class="card-icon"><i class="fa fa-check-circle text-success fs-1"></i></p>
                            <h4 class="card-title">Payment Successful!</h4>

                            <h5 class="text-muted">Payment ID: <b class="text-success"><?php echo htmlspecialchars($payment_id); ?></b></h5>

                            <p class="card-text mb-1">Thank you for shopping with Green Life.</p>
